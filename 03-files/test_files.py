...
Explicit is better than implicit.""")
    ...
    def test_file_contains(self):
        ...
        self.assertIs(files.contains('better', 'test.txt'), True)
        self.assertIs(files.contains('Hello', 'test.txt'), False)
        self.assertIs(files.contains('a', 'zen.txt'), True)
        self.assertIs(files.contains('invalid', 'test.txt'), False)
