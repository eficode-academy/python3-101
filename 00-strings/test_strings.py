...
class TestStrings(unittest.TestCase):
    ...
    def test_tokens(self):
        # implement strings.tokens where token is strings separated with dot (.). strings.token should return a list of substrings split from . and removes empty tokens
